...
function interpolation(code_path, folder_path, analysis_dir, st_dir, ip_dir, op_dir, par_dir, csv_data, pixelsize, framesize, padsize)
    close all;

    % cd '/Users/michaelshih/Documents/code/wucci/storm_image_processing'
    % 
    ...
    % op_dir = 'spacialdata_pad_local_int';
    % par_dir = 'par';
